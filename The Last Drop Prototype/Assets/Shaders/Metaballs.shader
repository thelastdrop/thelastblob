...
SubShader {
	...
	half4 frag (v2f i) : COLOR{		
		...
		if(texcol.r>0.3){ // This is for the lava effect, easiest one!
			...
			finalColor=floor(finalColor/0.04)*0.6; //The floor function for the metaball effect play around the 2 values for different effects (use the color preview at the scene!)		    
	    }
